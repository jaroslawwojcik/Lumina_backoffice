...
export function ContentPage() {
  ...
  return <Box sx={{ maxWidth: 1440, p: { xs: 2.25, md: 3.25 } }}>
    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ alignItems: 'flex-start', justifyContent: 'space-between', mb: 3 }}>
      ...
      {canCreate && <Stack direction="row" useFlexGap spacing={1} sx={{ flexWrap: 'wrap' }}><Button component={Link} to="/content/materials/new" variant="outlined" startIcon={<AddOutlined />}>Nowy materiał</Button><Button component={Link} to="/content/sessions/new" variant="contained" startIcon={<AddOutlined />}>Nowa sesja</Button><Button aria-controls={createMenuAnchor ? 'create-content-menu' : undefined} aria-expanded={Boolean(createMenuAnchor)} aria-haspopup="true" onClick={(event: MouseEvent<HTMLButtonElement>) => setCreateMenuAnchor(event.currentTarget)} startIcon={<AddOutlined />} variant="contained">Nowa treść</Button><Menu anchorEl={createMenuAnchor} id="create-content-menu" onClose={() => setCreateMenuAnchor(null)} open={Boolean(createMenuAnchor)}><MenuItem component={Link} onClick={() => setCreateMenuAnchor(null)} to="/content/sessions/new">Nowa sesja</MenuItem><MenuItem component={Link} onClick={() => setCreateMenuAnchor(null)} to="/content/programs/new">Nowy program</MenuItem><MenuItem component={Link} onClick={() => setCreateMenuAnchor(null)} to="/content/materials/new">Nowy materiał</MenuItem></Menu></Stack>}
    </Stack>
